	...
	public function getItem($pk = null)
	{
		if ($item = parent::getItem($pk)) {
			...
			$item->components = $registry->toArray();
                        // Convert the jmsproducts field to an array.
                        $registry = new JRegistry;
			$registry->loadString($item->jmsproducts);
			$item->jmsproducts = $registry->toArray();
                         // Convert the jmscategories field to an array.
                        $registry = new JRegistry;
			$registry->loadString($item->jmscategories);
			$item->jmscategories = $registry->toArray();
