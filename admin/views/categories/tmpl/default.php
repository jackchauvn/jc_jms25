...
<form action="<?php echo JRoute::_('index.php?option=com_jms&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo JHtml::_('grid.sort', 'COM_JMS_CATEGORIES_TITLE', 'a.title', $listDirn, $listOrder); ?>
                </th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                $categoryLink = JRoute::_('index.php?option=com_jms&task=category.edit&id=' . $item->id);
                ?>
    ...
    <?php echo JHtml::_('grid.id', $i, $item->id); ?>
                    ...
                    <td class="left">
                        <a href="<?php echo $categoryLink; ?>" class="hasTip" title="<?php echo JText::_('COM_JMS_TITLE_CATEGORY_EDIT'); ?>::<?php echo $this->escape($item->title); ?>"><?php echo $item->title; ?></a>
                        <p class="smallsub">
