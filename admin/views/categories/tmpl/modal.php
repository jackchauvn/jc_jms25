...
$userId = $user->get('id');
$function = JRequest::getCmd('function', 'jSelectCategories');
...
<form action="<?php echo JRoute::_('index.php?option=com_jms&view=categories&layout=modal&tmpl=component&groups='.JRequest::getVar('groups', '', 'default', 'BASE64').'&excluded='.JRequest::getVar('excluded', '', 'default', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
