    ...
    <div class="width-100">
        ...
        <fieldset class="adminform">
            ...
            <ul class="adminformlist">
                ...
                <li>
                    <?php echo $this->form->getLabel('number_of_installments'); ?>
                    <?php echo $this->form->getInput('number_of_installments'); ?>
                    <div class="clr"></div>
                    <p>
                        <a href="http://www.joomlamadesimple.com/JMS-Membership-Sites/paypal-limitations.html">
                            <?php echo JText::_('*Paypal limitations'); ?>
                        </a>
                    </p>
                </li>
                ...
                <li><?php echo $this->form->getLabel('hidden_plan'); ?>
                    <?php echo $this->form->getInput('hidden_plan'); ?></li>
        ...
        <fieldset class="adminform">
            ...
            <ul class="adminformlist">
                ...
                <li><?php echo $this->form->getLabel('ihub_crm'); ?>
                    <?php echo $this->form->getInput('ihub_crm'); ?></li>
                
                <li><?php echo $this->form->getLabel('ihub_crm_url'); ?>
                    <?php echo $this->form->getInput('ihub_crm_url'); ?></li>
                
                <li><?php echo $this->form->getLabel('publicid'); ?>
                    <?php echo $this->form->getInput('publicid'); ?></li>
                
                <li><?php echo $this->form->getLabel('firstname'); ?>
                    <?php echo $this->form->getInput('firstname'); ?></li>
                
                <li><?php echo $this->form->getLabel('custom_code'); ?>
                    <?php echo $this->form->getInput('custom_code'); ?></li>
        ...
        <?php echo JHtml::_('tabs.panel', JText::_('COM_JMS_LEGEND_REWARD_POINTS'), 'tab5'); ?> 
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_JMS_LEGEND_REWARD_POINTS'); ?></legend>
            <ul class="adminformlist">
                <li><?php echo $this->form->getLabel('grant_points'); ?>
                    <?php echo $this->form->getInput('grant_points'); ?></li>

                <li><?php echo $this->form->getLabel('points_expire'); ?>
                    <?php echo $this->form->getInput('points_expire'); ?></li>
            </ul>
        </fieldset>
        
        <?php echo JHtml::_('tabs.panel', JText::_('COM_JMS_LEGEND_PRODUCTS'), 'tab6'); ?> 
        <fieldset class="adminform">
            <legend><?php echo JText::_('COM_JMS_LEGEND_PRODUCTS'); ?></legend>
            <ul class="adminformlist">
                <li><?php echo $this->form->getLabel('jmsproducts'); ?>
                    <?php echo $this->form->getInput('jmsproducts'); ?></li>

                <li><?php echo $this->form->getLabel('jmscategories'); ?>
                    <?php echo $this->form->getInput('jmscategories'); ?></li>
            </ul>
        </fieldset>
