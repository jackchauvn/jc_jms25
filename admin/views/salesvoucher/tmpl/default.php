...
$select[0]->text = "All";
$select[1]->value = 1;
$select[1]->text = "Vuocher title";
?>

<form action="<?php echo JRoute::_('index.php?option=com_jms&view=salesvoucher'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo JHtml::_('grid.sort', 'COM_JMS_SALES_VUOCHER', 'a.title', null, null); ?>
                </th>
