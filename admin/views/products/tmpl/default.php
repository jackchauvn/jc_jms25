...
<form action="<?php echo JRoute::_('index.php?option=com_jms&view=products'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo JHtml::_('grid.sort', 'COM_JMS_PRODUCTS_PRICE', 'a.price', $listDirn, $listOrder); ?>
                </th>

                <th>
                    <?php echo JHtml::_('grid.sort', 'COM_JMS_PRODUCTS_PRICE_POINTS', 'a.price_points', $listDirn, $listOrder); ?>
                </th>

                <th>
                    <?php echo JHtml::_('grid.sort', 'COM_JMS_PRODUCTS_DESCRIPTION', 'a.description', $listDirn, $listOrder); ?>
                </th>
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                $productLink = JRoute::_('index.php?option=com_jms&task=product.edit&id=' . $item->id);
                ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="left">
                        <a href="<?php echo $productLink; ?>" class="hasTip" title="<?php echo JText::_('COM_JMS_TITLE_PRODUCT_EDIT'); ?>::<?php echo $this->escape($item->title); ?>"><?php echo $item->title; ?></a>
                        <p class="smallsub">
