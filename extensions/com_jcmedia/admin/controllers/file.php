...
class MediaControllerFile extends JControllerLegacy
{
	...
	public function upload()
	{
		...
		$params = JComponentHelper::getParams('com_jcmedia');
		...
		foreach ($files as &$file)
		{
			...
			$result = $dispatcher->trigger('onContentBeforeSave', array('com_jcmedia.file', &$object_file));
			...
			else
			{
				...
				$dispatcher->trigger('onContentAfterSave', array('com_jcmedia.file', &$object_file, true));
	...
	{
		if (!JFactory::getUser()->authorise('core.' . strtolower($action), 'com_jcmedia'))
		{
