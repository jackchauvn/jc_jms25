...
class MediaViewMedia extends JViewLegacy
{
	function display($tpl = null)
	{
		...
		$config = JComponentHelper::getParams('com_jcmedia');
	...
	protected function addToolbar()
	{
		...
		// Add a delete button
		if ($user->authorise('core.admin', 'com_jcmedia'))
		{
			JToolBarHelper::preferences('com_jcmedia', 450, 800, 'JToolbar_Options', '', 'window.location.reload()');
			JToolBarHelper::divider();
		}
