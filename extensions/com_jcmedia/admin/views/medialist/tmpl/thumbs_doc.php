...
?>
		<div class="imgOutline">
			...
			<?php if ($user->authorise('core.delete', 'com_jcmedia')):?>
				<a class="delete-item" target="_top" href="index.php?option=com_jcmedia&amp;task=file.delete&amp;tmpl=index&amp;<?php echo JSession::getFormToken(); ?>=1&amp;folder=<?php echo $this->state->folder; ?>&amp;rm[]=<?php echo $this->_tmp_doc->name; ?>" rel="<?php echo $this->_tmp_doc->name; ?>"><?php echo JHtml::_('image', 'media/remove.png', JText::_('JACTION_DELETE'), array('width' => 16, 'height' => 16), true); ?></a>
