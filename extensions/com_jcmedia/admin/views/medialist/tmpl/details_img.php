...
$dispatcher->trigger('onContentBeforeDisplay', array('com_jcmedia.file', &$this->_tmp_img, &$params));
?>
		<tr>
			<td>
		...
		<?php if ($user->authorise('core.delete', 'com_jcmedia')):?>
			<td>
				<a class="delete-item" target="_top" href="index.php?option=com_jcmedia&amp;task=file.delete&amp;tmpl=index&amp;<?php echo JSession::getFormToken(); ?>=1&amp;folder=<?php echo $this->state->folder; ?>&amp;rm[]=<?php echo $this->_tmp_img->name; ?>" rel="<?php echo $this->_tmp_img->name; ?>"><?php echo JHtml::_('image', 'media/remove.png', JText::_('JACTION_DELETE'), array('width' => 16, 'height' => 16), true); ?></a>
				<input type="checkbox" name="rm[]" value="<?php echo $this->_tmp_img->name; ?>" />
			</td>
		<?php endif;?>
		</tr>
<?php
$dispatcher->trigger('onContentAfterDisplay', array('com_jcmedia.file', &$this->_tmp_img, &$params));
?>
